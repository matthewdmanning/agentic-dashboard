...
| How to write and delegate code here, and when to stop                                                                | [`docs/agents/coding-conventions.md`](docs/agents/coding-conventions.md) — read it before you write or edit code                                                                                                                                                           |
...
| How to run the active agent MCP test, and how to build its prompt fixtures                                           | [`active-agent-trials/active-agent-mcp-test.md`](active-agent-trials/active-agent-mcp-test.md)                                                                                                                                                                             |
